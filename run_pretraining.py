  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    if mode == tf.compat.v1.estimator.ModeKeys.TRAIN:
      ...
      def metric_fn(masked_lm_example_loss, masked_lm_log_probs, masked_lm_ids,
        ...
        masked_lm_log_probs = tf.compat.v1.reshape(masked_lm_log_probs,
...
def gather_indexes(sequence_tensor, positions):
  ...
  flat_sequence_tensor = tf.compat.v1.reshape(sequence_tensor,
...
def input_fn_builder(input_files,
  ...
  def input_fn(params):
    ...
    name_to_features = {
        "input_ids":
            tf.compat.v1.FixedLenFeature([max_seq_length], tf.compat.v1.int64),
        "input_mask":
            tf.compat.v1.FixedLenFeature([max_seq_length], tf.compat.v1.int64),
        "segment_ids":
            tf.compat.v1.FixedLenFeature([max_seq_length], tf.compat.v1.int64),
        "masked_lm_positions":
            tf.compat.v1.FixedLenFeature([max_predictions_per_seq], tf.compat.v1.int64),
        "masked_lm_ids":
            tf.compat.v1.FixedLenFeature([max_predictions_per_seq], tf.compat.v1.int64),
        "masked_lm_weights":
            tf.compat.v1.FixedLenFeature([max_predictions_per_seq], tf.compat.v1.float32),
        "next_sentence_labels":
            tf.compat.v1.FixedLenFeature([1], tf.compat.v1.int64),
    }
