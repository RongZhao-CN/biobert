...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
  ...
  final_hidden_matrix = tf.compat.v1.reshape(final_hidden,
...
def input_fn_builder(input_file, seq_length, is_training, drop_remainder):
  ...
  name_to_features = {
      "unique_ids": tf.compat.v1.FixedLenFeature([], tf.compat.v1.int64),
  ...
  if is_training:
    name_to_features["start_positions"] = tf.compat.v1.FixedLenFeature([], tf.compat.v1.int64)
    name_to_features["end_positions"] = tf.compat.v1.FixedLenFeature([], tf.compat.v1.int64)
