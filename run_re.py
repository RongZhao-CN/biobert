...
def file_based_input_fn_builder(input_file, seq_length, is_training,
  ...
  name_to_features = {
      ...
      "label_ids": tf.compat.v1.FixedLenFeature([], tf.compat.v1.int64),
      "is_real_example": tf.compat.v1.FixedLenFeature([], tf.compat.v1.int64),
  }
...
def model_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    if "is_real_example" in features:
      is_real_example = tf.compat.v1.cast(features["is_real_example"], dtype=tf.compat.v1.float32)
    else:
      is_real_example = tf.compat.v1.ones(tf.compat.v1.shape(label_ids), dtype=tf.compat.v1.float32)
    ...
    d = tf.compat.v1.data.Dataset.from_tensor_slices({
        ...
        "segment_ids":
            tf.compat.v1.constant(
                ...
                dtype=tf.compat.v1.int32),
        "label_ids":
            tf.compat.v1.constant(all_label_ids, shape=[num_examples], dtype=tf.compat.v1.int32),
    })
